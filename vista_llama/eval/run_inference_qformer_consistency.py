...
def parse_args():
    ...
    parser.add_argument(
        "--num_video_frame", default=4, type=int, help="num of used video frame"
    )
    ...
    parser.add_argument(
        "--projection_path",
        type=str,
        default="/mnt/bn/vlp-v6/Video-ChatGPT/qformer/mm_projector/checkpoint-9000.bin",
    )
...
def run_inference(args):
    ...
    index = 0
    gt_contents = gt_contents[args.rank :: args.world_size]
