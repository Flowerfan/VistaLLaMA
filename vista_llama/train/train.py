...
from vista_llama.train.llava_trainer import VideoChatGPTTrainer
...
class DataCollatorForSupervisedDataset(object):
    ...
    def __call__(self, instances: Sequence[Dict]) -> Dict[str, torch.Tensor]:
        ...
        if self.use_visual_mask:
            v_token = self.tokenizer.convert_tokens_to_ids(
...
def make_supervised_data_module(tokenizer: transformers.PreTrainedTokenizer,
    ...
    data_collator = DataCollatorForSupervisedDataset(tokenizer=tokenizer, use_visual_mask=data_args.use_visual_mask)
