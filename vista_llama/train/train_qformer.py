...
from vista_llama.train.llava_trainer import VideoChatGPTQformerTrainer
...
class LazySupervisedDataset(Dataset):
    ...
    def __getitem__(self, i) -> Dict[str, torch.Tensor]:
        ...
        if 'video' in sources[0]:
            ...
            cur_token_len = 32  # 100 temporal + 256 spatial, TODO: Hard Coding is not good
...
def train():
    ...
    model = VideoChatGPTQformerLlamaForCausalLM.from_pretrained(
    ...
    model.load_from_pretrained('/mnt/bn/vlp-v6/Video-ChatGPT/checkpoints/blip2_pretrained_flant5xxl.pth')
    ...
    trainer = VideoChatGPTQformerTrainer(model=model, tokenizer=tokenizer, args=training_args, **data_module)
