...
conv_vicuna_v1_2 = Conversation(
    system="A chat between a curious user and an artificial intelligence assistant. "
    "The assistant gives helpful, detailed, and polite answers to the user's questions. This is a video containing 356 patch tokens.<video>",
    roles=("USER", "ASSISTANT"),
    version="v1",
    messages=(),
    offset=0,
...
conv_vicuna_v1_3 = Conversation(
    system="A chat between a curious user and an artificial intelligence assistant. "
    "The assistant gives helpful, detailed, and polite answers to the user's questions. Each frame is represented by a frame token. This is a video containing 100 frame tokens. <video>",
    roles=("USER", "ASSISTANT"),
    version="v1",
    messages=(),
    offset=0,
...
conv_vicuna_v1_4 = Conversation(
    system="A chat between a curious user and an artificial intelligence assistant. "
    "The assistant gives helpful, detailed, and polite answers to the user's questions. <video>",
    roles=("USER", "ASSISTANT"),
    version="v1",
    messages=(),
    offset=0,
...
conv_templates = {
    ...
    "vicuna_v1_2": conv_vicuna_v1_2,
    "vicuna_v1_3": conv_vicuna_v1_3,
    "vicuna_v1_4": conv_vicuna_v1_4,
}
